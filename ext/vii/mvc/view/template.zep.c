...
ZEPHIR_INIT_CLASS(Vii_Mvc_View_Template) {
	...
	ZEPHIR_REGISTER_CLASS(Vii\\Mvc\\View, Template, vii, mvc_view_template, vii_mvc_view_template_method_entry, 0);

	zend_declare_property_string(vii_mvc_view_template_ce, SL("left_delimiter"), "{", ZEND_ACC_PUBLIC TSRMLS_CC);

	zend_declare_property_string(vii_mvc_view_template_ce, SL("right_delimiter"), "}", ZEND_ACC_PUBLIC TSRMLS_CC);

	zend_declare_property_string(vii_mvc_view_template_ce, SL("content"), "", ZEND_ACC_PUBLIC TSRMLS_CC);

	zend_declare_property_null(vii_mvc_view_template_ce, SL("view"), ZEND_ACC_PUBLIC TSRMLS_CC);

	zend_declare_property_null(vii_mvc_view_template_ce, SL("block"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(vii_mvc_view_template_ce, SL("nocache"), ZEND_ACC_PUBLIC TSRMLS_CC);

	zend_declare_property_null(vii_mvc_view_template_ce, SL("config"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(vii_mvc_view_template_ce, SL("service"), ZEND_ACC_PROTECTED TSRMLS_CC);

	vii_mvc_view_template_ce->create_object = zephir_init_properties_Vii_Mvc_View_Template;
	return SUCCESS;
...
PHP_METHOD(Vii_Mvc_View_Template, getConfig) {
	...
	zephir_array_fetch(&_1, _0, key, PH_NOISY | PH_READONLY, "vii/mvc/view/template.zep", 26 TSRMLS_CC);
	RETURN_CTORW(_1);
...
PHP_METHOD(Vii_Mvc_View_Template, parseVarPath) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("config"), PH_NOISY_CC);
	zephir_is_iterable(_0, &_2, &_1, 0, 0, "vii/mvc/view/template.zep", 47);
	for (
...
PHP_METHOD(Vii_Mvc_View_Template, parseTags) {
	...
	object_init_ex(tagHandler, vii_mvc_view_defaulttag_ce);
	ZEPHIR_CALL_METHOD(NULL, tagHandler, "__construct", NULL, 105);
	zephir_check_call_status();
	_1 = zephir_fetch_nproperty_this(this_ptr, SL("content"), PH_NOISY_CC);
	ZEPHIR_CALL_METHOD(&_0, tagHandler, "parse", NULL, 106, _1);
	zephir_check_call_status();
...
PHP_METHOD(Vii_Mvc_View_Template, parseLoad) {
	...
	ZEPHIR_OBS_VAR(_0);
	zephir_read_static_property_ce(&_0, vii_mvc_view_taglibarys_ce, SL("left_delimiter") TSRMLS_CC);
	ZEPHIR_OBS_VAR(_1);
	zephir_read_static_property_ce(&_1, vii_mvc_view_taglibarys_ce, SL("right_delimiter") TSRMLS_CC);
	ZEPHIR_INIT_VAR(preg);
...
PHP_METHOD(Vii_Mvc_View_Template, parseBlock) {
	...
	zephir_read_static_property_ce(&_1, vii_mvc_view_taglibarys_ce, SL("right_delimiter") TSRMLS_CC);
	ZEPHIR_OBS_VAR(_2);
	zephir_read_static_property_ce(&_2, vii_mvc_view_taglibarys_ce, SL("left_delimiter") TSRMLS_CC);
	ZEPHIR_OBS_VAR(_3);
	zephir_read_static_property_ce(&_3, vii_mvc_view_taglibarys_ce, SL("right_delimiter") TSRMLS_CC);
	ZEPHIR_INIT_VAR(preg);
...
PHP_METHOD(Vii_Mvc_View_Template, _block) {
	...
	zephir_array_fetch_long(&_0, matchs, 2, PH_NOISY | PH_READONLY, "vii/mvc/view/template.zep", 122 TSRMLS_CC);
	...
	if (zephir_array_isset(_1, blockRep)) {
		zephir_array_fetch_long(&_2$$3, matchs, 3, PH_NOISY | PH_READONLY, "vii/mvc/view/template.zep", 125 TSRMLS_CC);
		zephir_update_property_array(this_ptr, SL("block"), blockRep, _2$$3 TSRMLS_CC);
		RETURN_MM_STRING("", 1);
	} else {
		zephir_array_fetch_long(&_3$$4, matchs, 3, PH_NOISY | PH_READONLY, "vii/mvc/view/template.zep", 128 TSRMLS_CC);
...
PHP_METHOD(Vii_Mvc_View_Template, loadDpr) {
	...
	zephir_array_fetch_long(&_1, data, 2, PH_NOISY | PH_READONLY, "vii/mvc/view/template.zep", 135 TSRMLS_CC);
	ZEPHIR_INIT_VAR(_2);
	ZVAL_BOOL(_2, 1);
	...
	if (!((zephir_file_exists(path TSRMLS_CC) == SUCCESS))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(_3$$3, "vii/mvc/view/template.zep", 137 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(content);
	...
	ZEPHIR_OBS_VAR(_5);
	zephir_read_static_property_ce(&_5, vii_mvc_view_taglibarys_ce, SL("left_delimiter") TSRMLS_CC);
	ZEPHIR_OBS_VAR(_6);
	zephir_read_static_property_ce(&_6, vii_mvc_view_taglibarys_ce, SL("right_delimiter") TSRMLS_CC);
	ZEPHIR_INIT_VAR(preg);
...
PHP_METHOD(Vii_Mvc_View_Template, _nocache) {
	...
	zephir_array_fetch_long(&_1, data, 1, PH_NOISY | PH_READONLY, "vii/mvc/view/template.zep", 158 TSRMLS_CC);
...
PHP_METHOD(Vii_Mvc_View_Template, replace_nocacheToVar) {
	...
	zephir_is_iterable(_0, &_2, &_1, 0, 0, "vii/mvc/view/template.zep", 168);
	for (
	  ; zephir_hash_get_current_data_ex(_2, (void**) &_3, &_1) == SUCCESS
	  ; zephir_hash_move_forward_ex(_2, &_1)
	) {
...
PHP_METHOD(Vii_Mvc_View_Template, replace_blockContent) {
	...
	zephir_is_iterable(_0, &_2, &_1, 0, 0, "vii/mvc/view/template.zep", 176);
	for (
	  ; zephir_hash_get_current_data_ex(_2, (void**) &_3, &_1) == SUCCESS
	  ; zephir_hash_move_forward_ex(_2, &_1)
	) {
