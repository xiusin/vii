...
ZEPHIR_INIT_CLASS(Vii_Mvc_View_Engine_Sleet_Compiler) {
	...
	ZEPHIR_REGISTER_CLASS(Vii\\Mvc\\View\\Engine\\Sleet, Compiler, vii, mvc_view_engine_sleet_compiler, vii_mvc_view_engine_sleet_compiler_method_entry, 0);

	zend_declare_property_null(vii_mvc_view_engine_sleet_compiler_ce, SL("view"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(vii_mvc_view_engine_sleet_compiler_ce, SL("content"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(vii_mvc_view_engine_sleet_compiler_ce, SL("parsed"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(vii_mvc_view_engine_sleet_compiler_ce, SL("parser"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zephir_declare_class_constant_long(vii_mvc_view_engine_sleet_compiler_ce, SL("NEVER"), 0);

	zephir_declare_class_constant_long(vii_mvc_view_engine_sleet_compiler_ce, SL("NOT_EXIST"), 1);

	zephir_declare_class_constant_long(vii_mvc_view_engine_sleet_compiler_ce, SL("IF_CHANGE"), 2);

	zephir_declare_class_constant_long(vii_mvc_view_engine_sleet_compiler_ce, SL("ALWAYS"), 3);
...
PHP_METHOD(Vii_Mvc_View_Engine_Sleet_Compiler, __construct) {
	...
	ZEPHIR_INIT_VAR(&_0);
	object_init_ex(&_0, vii_mvc_view_engine_sleet_parser_ce);
