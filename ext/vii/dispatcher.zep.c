...
PHP_METHOD(Vii_Dispatcher, getControllerSuffix) {
	...
	RETURN_MEMBER(this_ptr, "controllerSuffix");
...
PHP_METHOD(Vii_Dispatcher, dispatch) {
	...
	if (_5) {
		...
		if (!(zephir_is_true(&_7$$4))) {
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(NULL, this_ptr, "setmatches", NULL, 39, &_8$$6);
			zephir_check_call_status();
		}
	}
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "setmodulehandleinfo", NULL, 40);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_10, this_ptr, "gethandlercontroller", NULL, 41);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_9, this_ptr, "_exec", NULL, 42, &_10);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "sendcontent", NULL, 43, &_9);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Vii_Dispatcher, setModuleHandleInfo) {
	...
	if (!(ZEPHIR_IS_EMPTY(&_2))) {
		...
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "loadmodulebyname", NULL, 44, &handleModuleInfo, &_3$$3);
		zephir_check_call_status();
		ZEPHIR_OBS_VAR(&className);
		zephir_array_fetch_string(&className, &handleModuleInfo, SL("className"), PH_NOISY, "vii/dispatcher.zep", 109 TSRMLS_CC);
		ZEPHIR_INIT_VAR(&_4$$3);
		ZVAL_STRING(&_4$$3, "\\");
		ZEPHIR_CALL_FUNCTION(&_5$$3, "strrpos", NULL, 45, &className, &_4$$3);
		zephir_check_call_status();
		ZVAL_LONG(&_6$$3, 0);
...
PHP_METHOD(Vii_Dispatcher, setMatches) {
	...
	zephir_fetch_params(0, 1, 0, &matches_param);

	ZVAL_COPY_VALUE(&matches, matches_param);
...
PHP_METHOD(Vii_Dispatcher, _exec) {
	...
	if (unlikely(Z_TYPE_P(handlerClass_param) != IS_STRING && Z_TYPE_P(handlerClass_param) != IS_NULL)) {
		zephir_throw_exception_string(spl_ce_InvalidArgumentException, SL("Parameter 'handlerClass' must be a string") TSRMLS_CC);
		RETURN_MM_NULL();
	}
	if (likely(Z_TYPE_P(handlerClass_param) == IS_STRING)) {
	...
	ZEPHIR_CALL_METHOD(NULL, &_method, "__construct", NULL, 46, &handlerClass, &actionName);
	zephir_check_call_status();
	if (!(zephir_is_true(&_method))) {
		...
		ZEPHIR_CALL_METHOD(&_7$$5, &_method, "ispublic", NULL, 47);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(NULL, &_handler, "__construct", NULL, 14, &handlerClass);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_9$$5);
		ZVAL_STRING(&_9$$5, "Vii\\Mvc\\Controller");
		ZEPHIR_CALL_METHOD(&_8$$5, &_handler, "issubclassof", NULL, 48, &_9$$5);
		zephir_check_call_status();
		if (!(zephir_is_true(&_8$$5))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_10$$7, "__construct", NULL, 4, &_11$$7);
			zephir_check_call_status();
		...
		array_init(&_9$$5);
		ZEPHIR_CALL_METHOD(&_12$$5, &_handler, "newinstanceargs", NULL, 15, &_9$$5);
		zephir_check_call_status();
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&parameters, &_method, "getparameters", NULL, 49);
		zephir_check_call_status();
...
PHP_METHOD(Vii_Dispatcher, sendContent) {
	...
	ZEPHIR_CALL_FUNCTION(&beforeBuffer, "ob_get_clean", NULL, 50);
	zephir_check_call_status();
...
PHP_METHOD(Vii_Dispatcher, loadModuleByName) {
	...
	if (!((zephir_file_exists(&_6 TSRMLS_CC) == SUCCESS))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_7$$4, "__construct", NULL, 4, &_9$$4);
		zephir_check_call_status();
	...
	if (ZEPHIR_IS_EMPTY(&_10)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_11$$5, "__construct", NULL, 4, &_12$$5);
		zephir_check_call_status();
	...
	if (!(zephir_class_exists(&_14, 1 TSRMLS_CC))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_15$$6, "__construct", NULL, 4, &_17$$6);
		zephir_check_call_status();
	...
	if (!(zephir_instance_of_ev(&moduleClass, vii_interfaces_moduleinterface_ce TSRMLS_CC))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_20$$7, "__construct", NULL, 4, &_21$$7);
		zephir_check_call_status();
