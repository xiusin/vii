...
PHP_METHOD(Vii_Helper, obj2arr) {
	...
	ZEPHIR_CALL_FUNCTION(&arr, "get_object_vars", NULL, 53, obj);
	zephir_check_call_status();
	zephir_is_iterable(&arr, 1, "vii/helper.zep", 18);
...
PHP_METHOD(Vii_Helper, getOs) {
	...
	zephir_array_fetch_string(&_0, _SERVER, SL("HTTP_USER_AGENT"), PH_NOISY | PH_READONLY, "vii/helper.zep", 25 TSRMLS_CC);
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "iphone");
	ZEPHIR_CALL_FUNCTION(&_2, "stripos", &_3, 83, &_0, &_1);
	zephir_check_call_status();
	_4 = zephir_is_true(&_2);
	if (!(_4)) {
		zephir_array_fetch_string(&_5, _SERVER, SL("HTTP_USER_AGENT"), PH_NOISY | PH_READONLY, "vii/helper.zep", 25 TSRMLS_CC);
		ZEPHIR_INIT_NVAR(&_1);
		ZVAL_STRING(&_1, "ipod");
		ZEPHIR_CALL_FUNCTION(&_6, "stripos", &_3, 83, &_5, &_1);
		zephir_check_call_status();
		_4 = zephir_is_true(&_6);
	}
	zephir_array_fetch_string(&_7, _SERVER, SL("HTTP_USER_AGENT"), PH_NOISY | PH_READONLY, "vii/helper.zep", 27 TSRMLS_CC);
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "ipad");
	ZEPHIR_CALL_FUNCTION(&_8, "stripos", &_3, 83, &_7, &_1);
	zephir_check_call_status();
	zephir_array_fetch_string(&_9, _SERVER, SL("HTTP_USER_AGENT"), PH_NOISY | PH_READONLY, "vii/helper.zep", 29 TSRMLS_CC);
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "android");
	ZEPHIR_CALL_FUNCTION(&_10, "stripos", &_3, 83, &_9, &_1);
	zephir_check_call_status();
	if (_4) {
...
PHP_METHOD(Vii_Helper, getHttpMethod) {
	...
	zephir_array_fetch_string(&_0, _SERVER, SL("REQUEST_METHOD"), PH_NOISY | PH_READONLY, "vii/helper.zep", 43 TSRMLS_CC);
...
PHP_METHOD(Vii_Helper, getFileExtension) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, ".");
	ZEPHIR_CALL_FUNCTION(&_1, "strrpos", NULL, 43, &path, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Vii_Helper, _t) {
	...
	ZEPHIR_CALL_CE_STATIC(&_0, vii_i18n_ce, "getdefault", &_1, 0);
	zephir_check_call_status();
...
PHP_METHOD(Vii_Helper, dump) {
	...
	object_init_ex(&dump, vii_dump_ce);
	ZEPHIR_CALL_METHOD(NULL, &dump, "__construct", NULL, 84);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_1);
	zephir_get_args(&_1);
	ZEPHIR_CALL_METHOD(&_0, &dump, "all", NULL, 85, &_1);
	zephir_check_call_status();
