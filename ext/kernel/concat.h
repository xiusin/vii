...
#define ZEPHIR_CONCAT_SVSVSS(result, op1, op2, op3, op4, op5, op6) \
	 zephir_concat_svsvss(result, op1, sizeof(op1)-1, op2, op3, sizeof(op3)-1, op4, op5, sizeof(op5)-1, op6, sizeof(op6)-1, 0);
#define ZEPHIR_SCONCAT_SVSVSS(result, op1, op2, op3, op4, op5, op6) \
	 zephir_concat_svsvss(result, op1, sizeof(op1)-1, op2, op3, sizeof(op3)-1, op4, op5, sizeof(op5)-1, op6, sizeof(op6)-1, 1);
...
#define ZEPHIR_CONCAT_SVSVVSVVV(result, op1, op2, op3, op4, op5, op6, op7, op8, op9) \
	 zephir_concat_svsvvsvvv(result, op1, sizeof(op1)-1, op2, op3, sizeof(op3)-1, op4, op5, op6, sizeof(op6)-1, op7, op8, op9, 0);
#define ZEPHIR_SCONCAT_SVSVVSVVV(result, op1, op2, op3, op4, op5, op6, op7, op8, op9) \
	 zephir_concat_svsvvsvvv(result, op1, sizeof(op1)-1, op2, op3, sizeof(op3)-1, op4, op5, op6, sizeof(op6)-1, op7, op8, op9, 1);
...
#define ZEPHIR_CONCAT_SVVSVSVSVSVSVS(result, op1, op2, op3, op4, op5, op6, op7, op8, op9, op10, op11, op12, op13, op14) \
	 zephir_concat_svvsvsvsvsvsvs(result, op1, sizeof(op1)-1, op2, op3, op4, sizeof(op4)-1, op5, op6, sizeof(op6)-1, op7, op8, sizeof(op8)-1, op9, op10, sizeof(op10)-1, op11, op12, sizeof(op12)-1, op13, op14, sizeof(op14)-1, 0);
#define ZEPHIR_SCONCAT_SVVSVSVSVSVSVS(result, op1, op2, op3, op4, op5, op6, op7, op8, op9, op10, op11, op12, op13, op14) \
	 zephir_concat_svvsvsvsvsvsvs(result, op1, sizeof(op1)-1, op2, op3, op4, sizeof(op4)-1, op5, op6, sizeof(op6)-1, op7, op8, sizeof(op8)-1, op9, op10, sizeof(op10)-1, op11, op12, sizeof(op12)-1, op13, op14, sizeof(op14)-1, 1);

#define ZEPHIR_CONCAT_SVVSVSVVS(result, op1, op2, op3, op4, op5, op6, op7, op8, op9) \
	 zephir_concat_svvsvsvvs(result, op1, sizeof(op1)-1, op2, op3, op4, sizeof(op4)-1, op5, op6, sizeof(op6)-1, op7, op8, op9, sizeof(op9)-1, 0);
#define ZEPHIR_SCONCAT_SVVSVSVVS(result, op1, op2, op3, op4, op5, op6, op7, op8, op9) \
	 zephir_concat_svvsvsvvs(result, op1, sizeof(op1)-1, op2, op3, op4, sizeof(op4)-1, op5, op6, sizeof(op6)-1, op7, op8, op9, sizeof(op9)-1, 1);
